...
## Summary
- 2126 nodes · 2559 edges · 158 communities detected
...
Cohesion: 0.01
Nodes (179): buyer_repository.dart, dart:convert, dart:io, build, MaterialApp, ReconciliationApp, BuyerFinancialYearStore, BuyerRepository (+171 more)
...
Cohesion: 0.02
Nodes (101): app/app.dart, BuyerFinancialYearRepository, buildPanPropagationLookupKey, _normalizeMappingKey, resolveSectionAwarePanPropagation, AutoMapDecision, CandidateScore, resolveLedgerSellerTitle (+93 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (99): buildSellerDisplayKey, buildSellerSectionDisplayKey, sortSections, copyWith, ReconciliationRow, ledgerSourceKeyForTransactionRow, ledgerSourceLabelForRow, reconciliationRowMatchesLedgerSource (+91 more)
...
Cohesion: 0.03
Nodes (79): AppCompactSelectField, build, _displayLabel, Function, Icon, LayoutBuilder, SizedBox, Align (+71 more)
...
Cohesion: 0.03
Nodes (68): extractPanFromGstin, isLegacyUnsupportedSection, looksLikePan, normalizeName, normalizePan, normalizeSection, sectionDisplayLabel, _applyFixedDetailColumnWidths (+60 more)
...
Cohesion: 0.04
Nodes (48): dart:math, _autoMapBestGuess, BoxDecoration, build, _buildFieldCard, _buildFieldsPanel, _buildFileInfoCard, _buildInfoChip (+40 more)
...
Cohesion: 0.05
Nodes (41): dart:typed_data, build, Container, DataCell, DataColumn, DataRow, dispose, initState (+33 more)
...
## Knowledge Gaps
- **1557 isolated node(s):** `MainActivity`, `main`, `app/app.dart`, `ReconciliationApp`, `build` (+1552 more)
